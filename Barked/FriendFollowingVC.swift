...
//  Barked
//
//  Created by MacBook Air on 7/24/17.
...
class FriendFollowingVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UserCellSubclassDelegate, UserCellProfilePressDelegate {
    
    var users = [Friend]()
    var displayedUsers = [String]()
    var followerUsers = [Friend]()
                ...
                if let uid = value["uid"] as? String {
                    ...
                    if let username = value["username"] as? String {
                        ...
                        if self.displayedUsers.contains(uid) {
                            ...
                            self.followerUsers.append(userToShow)
                            print("LIONSEYE - \(self.followerUsers)")
                        }
                    }
                }
            }
    ...
    func buttonTapped(cell: UserCell) {
        ...
        clickedUser = followerUsers[indexPath.row].userID
